...
- jsonaccess/3:
    Il predicato jsonaccess/3 risulta vero quando Result è
...
- jsonread/2:
    ...
    se riesce a costruire un oggetto JSON. 
    Se FileName non esiste il predicato fallisce. 
    Il suggerimento è di leggere l'intero file in una stringa e 
    poi di richiamare jsonparse/2.
